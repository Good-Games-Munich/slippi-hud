...
#BG {
	...
	width: 1920px;
	height: 1080px;
	background: url('./img/backgrounds/new-hud/setend.png') no-repeat 0px 0px;
	top: 0px;
	left: 0px;
}
...
#overlay {
	...
	left: 0px;
	top: 0px;
	background: url('./img/backgrounds/new-hud/setEnd-ssb2022.png') no-repeat 0px 0px;
	width: 1920px;
	height: 1080px;
}
#logo {
...
.frame {
	background: url('./img/backgrounds/new-hud/frame.png') 0px 0px no-repeat;
}
#t1 {
	width: 200px;
	height: 200px;
